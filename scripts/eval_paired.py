...
def main():
    ...
    ds=PairedRGBDataset(args.low_dir,args.high_dir,max_images=args.max_images,name=args.domain); loader=DataLoader(ds,batch_size=1,shuffle=False)
